...
const AddUser = ({isAdmin, setIsAdmin, isLeader, setIsLeader, user, setUser, activeLanguage, setActiveLanguage, lightModeActive, setLightModeActive, userLoggedIn, setUserLoggedIn, } : Props) => {
