...
const HolidayRequest = ({ user, setUser, activeLanguage, setActiveLanguage, lightModeActive, setLightModeActive, userLoggedIn, setUserLoggedIn, } : Props) => {
